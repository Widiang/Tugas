  ...
  <div class="navbar-wrapper">
    ...
    <div class="navbar-content">
      <ul class="pc-navbar">
        ...
        <li class="pc-item">
          <a href="<?=base_url('home/dashboard')?>" class="pc-link"><span class="pc-micon"><i class="ti ti-dashboard"></i></span><span
        ...
        <li class="pc-item">
          <a href="<?=base_url('home/pemesanan')?>" class="pc-link">
            <span class="pc-micon"><i class="ti ti-typography"></i></span>
            <span class="pc-mtext">Pemesanan</span>
          </a>
        </li>
        <li class="pc-item">
          <a href="<?=base_url('home/member')?>" class="pc-link">
      ...
      ?>
        <li class="pc-item">
          <a href="<?=base_url('home/laporan')?>" class="pc-link">
      ...
      <div class="dropdown-menu dropdown-user-profile dropdown-menu-end pc-h-dropdown">
        <div class="dropdown-header">
          ...
          <div class="profile-notification-scroll position-relative" style="max-height: calc(100vh - 280px)">
            ...
            <hr >
            <a href="<?=base_url('home/profile')?>" class="dropdown-item">
              <i class="ti ti-settings"></i>
