              ...
              <div class="row">
                <div class="d-flex justify-content-center">
                  <div class="auth-header">
                    <h2 class="text-secondary mt-5"><b>Hi</b></h2>
                    <p class="f-16 mt-2">Make an Account</p>
                  </div>
                </div>
              </div>
              <form class="row g-3 needs-validation" novalidate action="<?=base_url('home/buat_akun')?>"method="POST">
